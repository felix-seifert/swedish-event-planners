...
public class NewRequestsAMGridView extends Div {
    ...
    public NewRequestsAMGridView(NewRequestService newRequestService) {
        ...
        grid.setItems(newRequestService.getAllNewRequestsByStatus(Set.of(RequestStatus.UNDER_REVIEW_BY_AM)));
        ...
        rejectButton.addClickListener(e -> {
            ...
            requestToApprove.setRequestStatus(RequestStatus.REJECTED_BY_AM);
            newRequestService.putNewRequest(requestToApprove);
            clearForm();
            refreshGrid();
